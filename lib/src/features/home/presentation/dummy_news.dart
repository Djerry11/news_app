const List<Map<String, dynamic>> newsItems = [
  {
    ...
    'description':
        'Autonomous, AI-based players are coming to a gaming experience near you, and a new startup, Altera, is joining the fray to build this new guard of AI Research company Altera raised  million to build AI agents that can play video games alongside other players.',
    'url':
  ...
  },
  {
    ...
    'content':
        'Good news, crypto founders: Venture capital activity is picking up in your sector after falling to multi-year lows in late 2023. Put another way, venture folks appear more web3-bullish than before, even amid continuing regulatory scrutiny.',
  },
  {
    'source': {'id': 'techcrunch', 'name': 'TechCrunch'},
    'author': 'Alex Wilhelm',
    ...
    'url':
        'https://techcrunch.com/2024/05/08/techcrunch-minute-when-did-ipads-get-as-expensive-as-macbooks/',
    'urlToImage':
        'https://techcrunch.com/wp-content/uploads/2024/05/ipad-noplay.png?resize=1200,675',
    'publishedAt': '2024-05-08T14:52:26Z',
    'content':
        'Apple’s iPad event had a lot to like. New iPads with new chips and new sizes, a new Apple Pencil, and even some software updates. If you are a big fan of Apple hardware, well, it was probably a good day for you.',
  },
  {
    'source': {'id': 'techcrunch', 'name': 'TechCrunch'},
    ...
    'url':
        'https://techcrunch.com/2024/05/08/uber-promises-member-exclusives-as-uber-one-passes-1b-run-rate/',
    'urlToImage':
  ...
  },
  {
    ...
    'content':
        'We’ve all seen them. The inspector with a clipboard, walking around a building, ticking off the last time the fire extinguishers were checked, or if all the lights are working. They work in the TICC (Third-Party Inspection, Certification, and Calibration) industry.',
  },
  {
    'source': {'id': 'techcrunch', 'name': 'TechCrunch'},
    'author': 'Paul Sawers',
  ...
  },
  {
    ...
    'url':
        'https://techcrunch.com/2024/05/08/irobot-names-former-timex-head-gary-cohen-as-ceo/',
    'urlToImage':
    ...
    'content':
        'iRobot Tuesday announced the successor to longtime CEO, Colin Angle. Gary Cohen, who previously held chief executive roles at Timex and Qualitor Automotive, will be heading up the company, marking a major leadership change for the maker of Roomba vacuum cleaners.',
  },
];
